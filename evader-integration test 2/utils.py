...
QUADS_MODE_LIST_OBSTACLES = ['o_random', 'o_static_same_goal', 'o_ep_rand_bezier', 'o_ep_rand_bezier_multi', 'o_multi_layout']
QUADS_MODE_LIST_OBSTACLES_TEST = ['o_random', 'o_static_same_goal',
                                  'o_swap_goals',
                                  'o_ep_rand_bezier', 'o_ep_rand_bezier_multi', 'o_dynamic_same_goal', 'o_multi_layout']
...
QUADS_PARAMS_DICT = {
    ...
    'o_ep_rand_bezier_multi': [['circle_horizontal'], [0.0, 0.0]],
    'o_multi_layout': [['circle_horizontal'], [0.0, 0.0]],
}
